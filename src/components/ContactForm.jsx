...
const ContactForm = () => {
    ...
    const [isError, setIsError] = useState(false);23
    23
                    ...
                    <div className="p-6 bg-opacity-10 text-gray-400  shadow-xl rounded-lg transition-transform hover:scale-105">
                        ...
                        {isSubmitted && (
                            <div className="mb-6 p-4 bg-green-100 text-green-800 rounded-lg animate-pulse">
                                <p>Vielen Dank! Wir werden uns in Kürze mit Ihnen in Verbindung setzen.</p>
                            </div>
                        )}

                        {isError && (
                            <div className="mb-6 p-4 bg-red-100 text-red-800 rounded-lg">
                                <p>Fehler beim Senden der Nachricht. Bitte versuchen Sie es erneut.</p>
                            </div>
                        )}
