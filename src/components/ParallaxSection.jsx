  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white my-16">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-7xl font-heading font-bold text-white uppercase  animate__animated animate__fadeIn animate__delay-1s">
          Wir führen einzelne Arten von Dacharbeiten durch
        </h1>
        <div className=" grid grid-cols-1 gap-6 my-10 md:grid-cols-2 lg:grid-cols-3">
          <p className="text-md font-sans text-yellow-400 text-pretty mt-4">
