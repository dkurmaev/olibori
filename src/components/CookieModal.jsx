  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 bg-teal-800 text-white p-3 rounded-full shadow-lg z-50 hover:bg-gray-700"
      >
        <CogIcon className="h-6 w-6" />
        
      </button>

      {/* Баннер согласия на куки по центру страницы */}
      {isVisible && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
            <h2 className="text-2xl font-semibold mb-4 text-center">Wir nutzen Cookies</h2>
            <p className="text-gray-700 mb-6 text-center">
              Diese Website nutzt Cookies. Wir verwendet Cookies zur Verbesserung des Service. Bitte wählen Sie Ihre Präferenzen.
            </p>
